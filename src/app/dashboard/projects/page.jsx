  ...
  const [projects] = useState([
    {
      ...
      description:
        "Rebuilding the main corporate site with Next.js & Tailwind.",
      status: "active",
    ...
    },
    {
      ...
      description: "Developing the headless RESTful backend infrastructure.",
      status: "active",
    ...
    },
    {
      ...
      description: "Cross-platform mobile application deployment.",
      status: "on_hold",
    ...
    },
    {
      ...
      description: "Migrating old database records to the new architecture.",
      status: "completed",
